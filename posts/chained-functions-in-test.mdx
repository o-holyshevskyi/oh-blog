...
img: '/images/posts/PlaywrightChainedfunctions.png'
---
...
▶️▶️▶️[See the previous topic](https://oholsyhevskyi.com/posts/page-object-pattern)
...
```ts:./tests/add-new-todo-chained.spec.ts
