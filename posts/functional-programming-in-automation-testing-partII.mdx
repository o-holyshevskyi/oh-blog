...
img: '/images/posts/fp-partII.gif'
---
...
<a class="toc-link" href="https://oholsyhevskyi.com/posts/functional-programming-in-automation-testing-partI">**discussed so far**</a>. 
Here's what you can expect in this part:

<div class="table-of-contents">
- <a class="toc-link" href="#installing-required-libraries">Installing Required Libraries</a>
  - <a class="toc-link" href="#install-typeScript">Step 1: Install TypeScript</a>
  - <a class="toc-link" href="#install-playwright">Step 2: Install Playwright</a>
  - <a class="toc-link" href="#install-fp-ts">Step 3: Install fp-ts (Functional Programming in TypeScript)</a>
  - <a class="toc-link" href="#common-issues-and-troubleshooting">Common Issues and Troubleshooting</a>
- <a class="toc-link" href="#setting-up-project">Setting Up the Project</a>
  - <a class="toc-link" href="#project-file-structure">Project file structure</a>
- <a class="toc-link" href="#writing-functional-tests">Writing Functional Tests</a>
  - <a class="toc-link" href="#review-normal-playwright-tests">Review normal Playwright tests</a>
  - <a class="toc-link" href="#transformation-tests-in-fp-approach">Explore how to transform tests into functional programming approach</a>
- <a class="toc-link" href="#advanced-techniques">Advanced Techniques</a>
  - <a class="toc-link" href="#enhance-existing-tests">How to enhance existing tests with fixtures</a>
    - <a class="toc-link" href="#create-dedicated-fixture">Create a dedicated Fixture</a>
    - <a class="toc-link" href="#define-separate-modules-for-actions">Define separate modules for the actions</a>
    - <a class="toc-link" href="#use-the-fixture-in-test-files">Use the fixture in test files</a>
- <a class="toc-link" href="#conclusion">Conclusion</a>
- <a class="toc-link" href="#additional-resources">Additional Resources</a>
</div>
...
Please note that you need Node.js installed before proceeding with these installations. If you haven't already installed Node.js, you can download it from the official website: <a class="toc-link" href="https://nodejs.org">**Node.js**</a>
...
<a name="common-issues-and-troubleshooting"></a>
...
<a name="project-file-structure"></a>
...
<a name="writing-functional-tests"></a>

### Review normal Playwright tests
<a name="review-normal-playwright-tests"></a>
...
<a name="transformation-tests-in-fp-approach"></a>
...
<a name="enhance-existing-tests"></a>
...
<a name="create-dedicated-fixture"></a>
...
<a name="define-separate-modules-for-actions"></a>
...
<a name="use-the-fixture-in-test-files"></a>
