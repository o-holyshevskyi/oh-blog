...
const socialLinks = (theme: string) => [
  {
    ...
    img: <svg className={`${utilStyles.borderCircle} ${utilStyles.socialMediaImg}`} fill={theme === 'light' ? 'var(--primary-dim)' : 'var(--primary-dim)'} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
